...
export function Footer() {
  ...
  return (
    <footer 
      ref={footerRef}
      className="w-full py-6 px-8 flex flex-col md:flex-row items-center justify-between gap-6 border-t border-border/10 bg-primary dark:bg-[#151210] relative z-[60]"
    >
